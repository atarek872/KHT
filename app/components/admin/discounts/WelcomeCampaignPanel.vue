...
<template>
  <div class="admin-welcome-campaign-page">
    <header class="admin-campaign-panel__header">
      <p class="admin-page-header__eyebrow">KHT / Acquisition</p>
      <h2>Welcome popup</h2>
      <p>Control its timing, display page, content, destinations and selected coupon.</p>
    </header>
